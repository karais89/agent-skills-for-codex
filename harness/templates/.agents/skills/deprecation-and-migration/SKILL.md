...
description: Plans safe migrations and deprecations. Use when removing APIs, replacing systems, migrating users, or deciding whether to sunset old behavior.
---
