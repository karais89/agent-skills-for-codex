...
로컬 경로: `reference-repos/openai-codex`
...
로컬 경로: `reference-repos/andrej-karpathy-skills`
...
로컬 경로: `reference-repos/superpowers`
...
로컬 경로: `reference-repos/agent-skills`
...
로컬 경로: `reference-repos/harness_framework`
